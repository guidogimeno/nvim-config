...
vim.keymap.set("n", "<leader>B", ":lua require('dap').debug_test()")
vim.keymap.set("n", "<leader>lp", ":lua require('dap').debug_test()")
vim.keymap.set("n", "<leader>dr", ":lua require('dap').repl.open()")
